...
- Final automated send decision: AUTOMATED_PAPER_SEND_REJECTED_BY_PREFLIGHT
- Alpaca paper order submitted: False
- Block or submission reason: ["Paper Send Preflight is not PAPER_ORDER_SEND_ALLOWED", "live endpoint configured is blocked"]
