...
- Paper send status: AUTOMATED_PAPER_SEND_REJECTED_BY_PREFLIGHT
- Alpaca paper order id: none
- Error: none
- Block reasons: ["Paper Send Preflight is not PAPER_ORDER_SEND_ALLOWED", "live endpoint configured is blocked"]
...
- Paper send preflight status: PAPER_ORDER_SEND_INVALID

## Automation Limit Checks

- Automation limits PASS: True
