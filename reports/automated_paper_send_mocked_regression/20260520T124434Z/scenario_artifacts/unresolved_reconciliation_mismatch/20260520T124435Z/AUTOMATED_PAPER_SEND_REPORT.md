...
- Paper send status: AUTOMATED_PAPER_SEND_REJECTED_BY_RECONCILIATION
- Alpaca paper order id: none
- Error: none
- Block reasons: ["previous reconciliation mismatch unresolved"]
...
- Previous reconciliation mismatch unresolved: True
