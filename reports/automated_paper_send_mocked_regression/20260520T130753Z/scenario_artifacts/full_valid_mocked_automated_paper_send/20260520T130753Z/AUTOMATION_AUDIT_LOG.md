...
- Final automated send decision: AUTOMATED_PAPER_SEND_SUBMITTED
- Alpaca paper order submitted: True
- Block or submission reason: ["AUTOMATED_PAPER_SEND_SUBMITTED"]
